...
@section('title', 'Datos Del Habitante de calle ' . $habitante->nombre .' ' .$habitante->apellido)
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" style="display: flex; justify-content:center">
                                ...
                                @php
                                    $comunaHabitante = $habitante->comuna;
                                @endphp
                                    @if($habitante->image)
                                    <img src="{{ asset('uploads/habitante/'.$habitante->image) }}" alt="{{ $habitante->nombre }}" width="150px">
                                    @else
                            ...
                            <div class="row">
                                <div class="card-header" style="background-color:#70AADB ; color:white">
                                    <h4 class="title">Datos De Habitante</h4>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group label-floating ">
                                        <label class="control-label">Nombre </label>
                                        <p class="cuadro">{{ $habitante->nombre }}</p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                    <div class="form-group label-floating  ">
                                        <label class="control-label">apellido</label>
                                        <p class="cuadro">{{ $habitante->apellido }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                    <div class="form-group label-floating ">
                                        ...
                                        <p class="cuadro">{{ $habitante->tipoDocumento->nombre }}</p>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                    <div class="form-group label-floating ">
                                        <label class="control-label">Numero documento</label>
                                        <p class="cuadro">{{ $habitante->numerodocumento }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                    <div class="form-group label-floating ">
                                        ...
                                        <p class="cuadro">{{ $habitante->ciudad->nombre  }}</p>
                                    </div>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                    <div class="form-group label-floating ">
                                        ...
                                        <p class="cuadro">{{ str_replace('_', ' ', $habitante->comuna) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="card-header text-center" style="background-color:#70AADB; color:white;">
                                    <h4 class="title">Descripción</h4>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 d-flex align-items-center justify-content-center">
                                        <div class="form-group text-center">
                                            <p class="cuadro">{{ $habitante->descripcion }}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="card-header text-center" style="background-color:#70AADB; color:white;">
                                    <h4 class="title">Localizacion</h4>
                                </div>
                                <html lang="es">                                   
                                <head>
                                    <meta charset="UTF-8">
                                ...
                                <body>
                                    <h2>Mapa de Ocaña, Norte de Santander </h2>
                                    <div id="map"></div>
                                ...
                                var comunaHabitante = "{{ $comunaHabitante }}";

                                    if(comunaHabitante =='comuna_1'){
                                        var comunaCoords = [
                                    ...
                                    else if(comunaHabitante=='comuna_2'){
                                        var comunaCoords = [
                                            ...
                                            else if(comunaHabitante=='comuna_3'){
                                                var comunaCoords = [
                                            ...
                                            else if(comunaHabitante=='comuna_4'){
                                                var comunaCoords =  [
                                            ...
                                            else if(comunaHabitante=='comuna_5'){
                                                var comunaCoords =  [
                                            ...
                                            else if(comunaHabitante=='comuna_6'){
                                                var comunaCoords =  [
                                        ...
                                        var comuna = L.polygon(comunaCoords, {
                                            color: "blue",
                                            fillColor: "#3388ff",
                                            fillOpacity: 0.4
                                        }).addTo(map);
                                        comuna.bindPopup("<b>Comuna 3</b><br>Incluye varios barrios de Ocaña.");
                                    </script>

                                <script src="{{ asset('backend/dist/js/getComuna.js') }}"></script>
                                <script src="{{ asset('js/getComuna.js') }}"></script>
                                <input type="hidden" class="form-control" name="estado" value="1">
                                <input type="hidden" class="form-control" name="registradopor" value="{{ Auth::user()->id }}">
                            </div>

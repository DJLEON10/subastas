                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="nombre" placeholder="Ejemplo: Televisor Samsung" autocomplete="off" value="{{ $producto->nombre }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-md-3 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="number" step="0.01" class="form-control" name="precio" placeholder="Ejemplo: 1500.00" value="{{ $producto->precio }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-md-3 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="number" class="form-control" name="cantidad" placeholder="Ejemplo: 25" value="{{ $producto->cantidad }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="categoria" placeholder="Ejemplo: Electrodomésticos" value="{{ $producto->categoria }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea class="form-control" name="descripcion" rows="3" placeholder="Escribe una breve descripción...">{{ $producto->descripcion }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Incremento Minimo <strong style="color:red;">(*)</strong></label>
                                            <input type="number" class="form-control" name="incrementoMinimo" placeholder="" value="{{ $producto->incrementoMinimo }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            @if($producto->image)
                                                <img src="{{ asset('storage/' .$producto->image) }}" alt="" style="max-width: 100px; max-height: 100px;">
                                            @endif
                                            ...
                                            <input type="hidden" name="current_image" value="{{ $producto->image }}">
                                        </div>
                                </div>
                                <div class="row">
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="date" class="form-control-file" name="fechaInicio" id="fechaInicio" value="{{ $producto->fechaInicio }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Fecha de Finalizacion <strong style="color:red;">(*)</strong></label>
                                            <input type="date" class="form-control-file" name="fechaFin" id="fechaFin"  value="{{ $producto->fechaFin }}">
                                        </div>
                                    </div>
								</div>
                                        ...
                                        <label class="control-label" for="pais">País <strong style="color:red;">(*)</strong></label>
                                            <select id="pais" name="pais_id" class="form-control">
                                                ...
                                                @foreach($paises as $pais)
                                                    <option value="{{ $pais->id }}" {{ $pais->id == $producto->ciudad->departamento->pais->id ? 'selected' : '' }}>
                                                        {{ $pais->nombre }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                        ...
                                        <select id="departamento" name="departamento_id" class="form-control " data-route="{{ route('getDepartamentosEdit') }}">
                                            ...
                                            @foreach($departamentos as $departamento)
                                                <option value="{{ $departamento->id }}" {{ $departamento->id == $producto->ciudad->departamento->id ? 'selected' : '' }}>
                                                    {{ $departamento->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                        ...
                                        <select id="ciudad" name="ciudad_id" class="form-control" data-route="{{ route('getCiudads') }}">
                                            ...
                                            @foreach($ciudads as $ciudad)
                                                <option value="{{ $ciudad->id }}" {{ $ciudad->id == $producto->ciudad->id ? 'selected' : '' }}>
                                                    {{ $ciudad->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
